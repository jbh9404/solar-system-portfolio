  ...
  const experiences = [
    {
      ...
      period: "2021 - Present",
      details:
        "Led the frontend team to migrate legacy architecture to Next.js, improving performance by 40%.",
    },
    {
      role: "Web Developer",
      ...
      period: "2018 - 2021",
      details:
        "Developed responsive web applications for various clients and maintained existing enterprise software.",
    },
  ];
        ...
        <div className="relative border-l border-white/20 pl-8 space-y-10">
          {experiences.map((exp, idx) => (
            <div key={idx} className="relative">
              {/* Timeline dot */}
              <div
                className="absolute -left-[41px] top-1 h-5 w-5 rounded-full bg-[#f9d776] border-4 border-black"
                style={{ boxShadow: "0 0 10px #f9d776" }}
              />
